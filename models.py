...
class Beast(db.Model):
    ...
    abilities = db.Column("abilities", db.ARRAY, nullable=True)
    ...
    Integerelligence = db.Column("Integerelligence", db.Float, nullable=False)
    legendary_acts = db.Column("legendary_acts", db.ARRAY, nullable=True)
    lair_acts = db.Column("lair_acts", db.ARRAY, nullable=True)
    danger = db.Column("danger", db.Float, nullable=False)
    armor_class = db.Column("armor_class", db.Integer, nullable=False)
    lair_effects = db.Column("lair_effects", db.ARRAY, nullable=True)
    ...
    Stringength = db.Column("Stringength", db.Float, nullable=False)
    ...
    reactions = db.Column("reactions", db.ARRAY, nullable=True)
    actions = db.Column("actions", db.ARRAY, nullable=True)
...
class Item(db.Model):
    ...
    images = db.Column("images", db.ARRAY, nullable=True)
